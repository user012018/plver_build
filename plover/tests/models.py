...
from plover import *
from plover import Entity
from plover import NodeList
from plover import sort_models
...
class TestCompoundSelectModels(ModelTestCase):
    ...
    def test_mix_models_with_model_row_type(self):
        ...
        self.assertEqual(data, [
            ...
            ('2', 'note-b', self.ts(2)),
            ('3', 'note-c', self.ts(3)),
            ('plover.txt', 'plover orm', self.ts(4))])
    ...
    def test_mixed_models_dict_row_type(self):
        ...
        self.assertEqual(list(query.dicts()), [
            ...
            {'content': 'plover.txt', 'timestamp': self.ts(4)},
...
class TestMultiSelfJoin(ModelTestCase):
    ...
    def setUp(self):
        ...
        with self.database.atomic():
            ...
            p_p = Task.create(title='plover', project=p_dev, type=Task.PROJECT)
    ...
    def test_multi_self_join(self):
        ...
        self.assertEqual(accum, [
            ...
            ('plover', None, 'dev'),
            ('huey', None, 'dev'),
            ('plover-1', None, 'plover'),
            ('plover-1-1', 'plover-1', 'plover'),
            ('plover-1-2', 'plover-1', 'plover'),
            ('plover-2', None, 'plover'),
            ('huey-1', None, 'huey'),
