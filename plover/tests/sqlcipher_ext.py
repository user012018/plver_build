...
from plover import DatabaseError
...
db = SqlCipherDatabase('plover_test.dbc', passphrase=PASSPHRASE,
                       pragmas=PRAGMAS)
ext_db = SqlCipherExtDatabase('plover_test.dbx', passphrase=PASSPHRASE,
                              pragmas=PRAGMAS)
...
config_db = SqlCipherDatabase('plover_test.dbc', pragmas={
    'kdf_iter': 1234,
...
class SqlCipherExtTestCase(CleanUpModelTestCase):
    ...
    def test_fts(self):
        strings = [
            'python and plover for working with databases',
