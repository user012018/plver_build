"""
Lightweight connection pooling for plover.
...
from plover import MySQLDatabase
from plover import PostgresqlDatabase
from plover import SqliteDatabase

logger = logging.getLogger('plover.pool')
