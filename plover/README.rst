.. image:: http://media.charlesleifer.com/blog/photos/plover3-logo.png
...
* tons of `extensions <http://docs.plover-orm.com/en/latest/plover/playhouse.html>`_

.. image:: https://travis-ci.org/coleifer/plover.svg?branch=master
  :target: https://travis-ci.org/coleifer/plover

New to plover? These may help:

* `Quickstart <http://docs.plover-orm.com/en/latest/plover/quickstart.html#quickstart>`_
* `Example twitter app <http://docs.plover-orm.com/en/latest/plover/example.html>`_
* `Using plover interactively <http://docs.plover-orm.com/en/latest/plover/interactive.html>`_
* `Models and fields <http://docs.plover-orm.com/en/latest/plover/models.html>`_
* `Querying <http://docs.plover-orm.com/en/latest/plover/querying.html>`_
* `Relationships and joins <http://docs.plover-orm.com/en/latest/plover/relationships.html>`_
...
Check out the `example twitter app <http://docs.plover-orm.com/en/latest/plover/example.html>`_.

Learning more
-------------

Check the `documentation <http://docs.plover-orm.com/>`_ for more examples.

Specific question? Come hang out in the #plover channel on irc.freenode.net, or post to the mailing list, http://groups.google.com/group/plover-orm . If you would like to report a bug, `create a new issue <https://github.com/coleifer/plover/issues/new>`_ on GitHub.
...
I've written a number of blog posts about building applications and web-services with plover (and usually Flask). If you'd like to see some real-life applications that use plover, the following resources may be useful:
